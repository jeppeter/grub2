...
void EXPORT_FUNC(grub_real_static_boot_time_buffer) ( const char* file, const int line, 
...
#define grub_static_boot_timer_buffer(ptr,size,...) grub_real_static_boot_timer_buffer(GRUB_FILE, __LINE__, (unsigned char*) (ptr), (int)(size),__VA_ARGS__)
#else
#define grub_boot_time(...)
#define grub_static_boot_time(...)
#define grub_static_boot_timer_buffer(ptr,size,...)
#endif
